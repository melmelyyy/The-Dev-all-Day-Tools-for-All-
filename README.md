...
This list results from Pull Requests, reviews, ideas, and work done by 1600+ people. You can also help by sending [Pull Requests]([https://github.com/ripienaar/free-for-dev](https://github.com/melmelyyy/The-Dev-all-Day-Tools-for-All?tab=readme-ov-file#free-fordev)) to add more services or remove ones whose offerings have changed or been retired.
